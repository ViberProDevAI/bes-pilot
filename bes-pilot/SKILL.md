---
name: bes-pilot
description: Türkiye Bireysel Emeklilik Sistemi (BES) için operasyonel skill. Her yanıtın ilk satırında "🎯 bes-pilot v0.2.0 başladı" yaz — bu olmadan skill aktif değildir. AskUserQuestion ile çoktan seçmeli wizard kullan, düz metin soru yasak. İlk soru kurum sorgusu (18 BES kurumu listesi). WebSearch ile bu haftanın lider EYF fonlarını araştır (TVH, TBJ, GCN, YZD, FFC gibi 3 harfli kodlar) — generic "hisse senedi fonu" kategorisi önerme. BES yatırımı EYF fonlarına yapılır, hisse senedine değil. Sepet onayından sonra browser MCP ile eSube'ye gir, fon dağılım sayfasına git, BEFAS aç, fonları seç, yüzdeleri yaz, toplamı doğrula. Sadece "Tamam" butonu için kullanıcı durur. memory/users altına profile.md, current_basket.md, history dosyaları yaz. Yıllık fon değişiklik hakkı 12 (Genelge 2026/1) — eski "6 hak" bilgisi yanlış. Sözleşme 6. yılından sonra fon gider iadesi başlar (BES Yönetmeliği Madde 22/A); BEFAS üzerinden alınan diğer kurum fonları iadeye dahil değil. Use when user asks "BES sepetimi kur", "BES revize", "emeklilik fonu", "BEFAS sepeti", veya Türkiye Hayat / Anadolu Hayat / Garanti / Allianz / Agesa / HDI Fiba / AvivaSA / NN Hayat herhangi bir BES kurumundan bahsettiğinde. Yatırım tavsiyesi değil, operasyonel rehber.
---
